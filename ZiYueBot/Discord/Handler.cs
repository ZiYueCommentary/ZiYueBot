        ...
        try
        {
            ...
            switch (command.CommandName)
            {
                ...
                case "扔海峡云瓶":
                {
                    ...
                    await command.RespondAsync(throwStraitbottle.DiscordInvoke(EventType.GroupMessage, userMention,
                        userId,
                ...
                case "捞海峡云瓶":
                {
                    ...
                    string result =
                        pickStraitbottle.DiscordInvoke(EventType.GroupMessage, userMention, userId, ["捞海峡云瓶"]);
